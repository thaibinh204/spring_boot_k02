...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
	...
	void saveSql(@Param("customerName") String customerName, @Param("contactName") String contactName,
			@Param("address") String address, @Param("city") String city, @Param("postalcode") String postalcode,
	...
	void updateSql(@Param("customerName") String customerName, @Param("contactName") String contactName,
			@Param("address") String address, @Param("city") String city, @Param("postalcode") String postalcode,
			@Param("country") String country, @Param("id") Long id);
	...
	// new CustomerDeptDto la sua dung contructor co tham so chuyen vao trong class CustomerDeptDto  
	@Query(value = " select new com.k02.dto.CustomerDeptDto(c.customerName,"
			+ " c.address, c.country, d.name, c.sex) " 
	        + " from  Customer c "
